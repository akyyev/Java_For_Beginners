package Beginner.day20_JavaRecap;
...
public class StringMethods {
	...
	public static void main(String[] args) {
		 ...
		 */
			...
			String str ="Learner School";  // String literals
			
				str.substring(0, str.indexOf("k") +1 );
				
				System.out.println(str); // learner school, String is immutable
		
			str = str.substring(0, str.indexOf("k") +1 );
			
			System.out.println(str);  // Learner
			
			
			String str2 ="Learner School";
		...
		// lastIndexOf(): returns the last occurred char's index num
			...
			String name ="Learner School Section 12";
	...
	// replaceFirst: replaces the ifrst occurred old character with the new one
		...
		/*
		        == , equals,  equalIgnoreCase		
		 */
				String R1 ="Learner";  // String pool
				String R2 =new String("Learner");  // heap
				
				String R3 = new String("learner"); // heap
	...
	String N2 ="Tomorrow is gonna be  a great day to do repl.its";
		...
		// startsWith & endsWith:  returns boolean, checks the starting and ending values
			...
			String Gmail ="learnerSchool@gmail.com";
	...
	// concat: concates two String values:
			 	String SchoolName ="Learner";
			 	SchoolName = SchoolName.concat(" School");  
			 	//"Learner School
			 	System.out.println(SchoolName); 
			 	
			 	String schoolName2 ="Learner "+123;  
