package Beginner.day36_JavaReveiw;
...
public class ArrayListReveiw {
	...
	// size(): returns the total number of elements in the list ( similar with lenght method in array
		...
		ArrayList<String> students = new ArrayList<>();
				...
				students.set(4, "Happy birthday Kai");
				System.out.println(students);
		
				
			// indexOf(Object): return's the first matching object's index number
			System.out.println( students.indexOf("Reece") ); //2
		
			// lastIndexOf(Object): returns the last matching object's index number
			System.out.println(students.lastIndexOf("Reece"));  //5
		...
		// Contains(Object): checks if the given object is contained in the arraylist or not, and returns boolean expression
			...
			System.out.println(students.contains("John"));  // false
			
			System.out.println(students.contains("Reece"));  // true
			System.out.println(students.contains("Mary"));  // false
	...
	ArrayList<Integer>  nums = new ArrayList<>(Arrays.asList(1,1,1,1,2,2,3,1));
		...
		*/	
		...
		n1.addAll( Arrays.asList("Yasin", "Rexx", "Olya") );
