...
public class staticBlockPractice {
	...
	public static String name;  // "suna" , "Mary", "Mike"
	public static int[] arr1;
	
	public static ArrayList<String> list = new ArrayList<>();
	public static ArrayList<String> students = new ArrayList<>();
	
	public static String[] online = {"Amy","Me","Spike","Seth","Bob","Kelly"};
	public static String[] inClass = {"Daryna","Jane","Olga","Cory"};
	...
	static {
		...
		a=400;
		list.add(3, "Kelly");  // we cannot skip idexes
